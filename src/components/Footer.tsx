...
export default function Footer() {
  return (
    <footer className="bg-footer-mobile lg:bg-footer-desktop bg-cover">
      <div className="container py-8 sm:py-16 lg:p-16 flex flex-col gap-y-8 lg:flex-row items-start text-base-footer">
        <div className="flex flex-col  items-start lg:items-center gap-5 max-w-sm lg:text-center lg:self-center">
          ...
          <p className="text-xs sm:text-base">Rua Manual João Souza, 540, São Paulo/SP - Brasil CNPJ: 000000/0000-00</p>
          <div className="flex gap-5 items-center">
            <Link className="duration-300 hover:brightness-125" href="#" aria-label="instagram">
              <img className="w-full h-full" src="/assets/instagram-icon.svg" alt="" height={34} width={34} />
            </Link>
            <Link className="duration-300 hover:brightness-125" href="#" aria-label="facebook">
              <img className="w-full h-full" src="/assets/facebook-icon.svg" alt="" height={34} width={34} />
            </Link>
          </div>
        </div>
